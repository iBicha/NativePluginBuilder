...
namespace iBicha
{
    public class CMakeHelper
    {
        ...
        public static void Build(NativePlugin plugin, BuildTarget buildTarget, BuildType buildType = BuildType.Debug, Architecture arch = Architecture.Any)
        {
            ...
            switch (buildTarget)
            {
                ...
                case BuildTarget.WebGL:
                    ...
                    {
                        Environment.SetEnvironmentVariable("LLVM", "C:/Program Files/Unity 2017.2.0f3/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/Emscripten_FastComp_Win", EnvironmentVariableTarget.User);
                    }
                    if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("NODE", EnvironmentVariableTarget.User)))
                    {
                        Environment.SetEnvironmentVariable("NODE", "C:/Program Files/Unity 2017.2.0f3/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/Emscripten_Win/node/node.exe", EnvironmentVariableTarget.User);
                    }
                    ...
                    //C:\Ruby23-x64\DevKit\bin\make.exe
                    //args.Add(string.Format("-DCMAKE_MAKE_PROGRAM=\"{0}\" ", GetEmscriptenLocation() + "/emmake"));
                    //args.Add(string.Format("-DCMAKE_MAKE_PROGRAM=\"{0}\" ", "C:\\Ruby23-x64\\DevKit\\bin\\make.exe"));
        ...
        {
            //TODO: get Unity editor location correctly
